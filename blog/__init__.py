...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>__init__.py : /home/canparlak/mysite/blog/__init__.py : Editor : canparlak : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="__init__.py : /home/canparlak/mysite/blog/__init__.py : Editor : canparlak : PythonAnywhere">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          save: "/user/canparlak/files/home/canparlak/mysite/blog/__init__.py",
          check_hash: "/user/canparlak/files/home/canparlak/mysite/blog/__init__.py",
          run: "/user/canparlak/files/home/canparlak/mysite/blog/__init__.py" + "?run",
          update_editor_mode_preference: "/user/canparlak/account/update_editor_mode_preference",
        });
        var filename = "/home/canparlak/mysite/blog/__init__.py";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            path: "/home/canparlak/mysite/blog/__init__.py"
          }
        );
