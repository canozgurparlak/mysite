...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>admin.py : /home/canparlak/mysite/blog/admin.py : Editor : canparlak : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="admin.py : /home/canparlak/mysite/blog/admin.py : Editor : canparlak : PythonAnywhere">
        ...
        <link rel="stylesheet" href="/static/CACHE/css/ad915e4713ae.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="/static/CACHE/css/ec1e06dca4f2.css" type="text/css" /><link rel="stylesheet" href="/static/CACHE/css/def9afdeb602.css" type="text/css" media="screen" />

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "SqdZY35mp5BWy9zZmEnV7UU6OERVyTC5";
        </script>
        <script type="text/javascript" src="/static/CACHE/js/8dc09e227063.js"></script>
        

        <script type="text/javascript" src="/static/CACHE/js/ebb3c10adcc1.js"></script>
        
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          save: "/user/canparlak/files/home/canparlak/mysite/blog/admin.py",
          check_hash: "/user/canparlak/files/home/canparlak/mysite/blog/admin.py",
          run: "/user/canparlak/files/home/canparlak/mysite/blog/admin.py" + "?run",
          update_editor_mode_preference: "/user/canparlak/account/update_editor_mode_preference",
        });
        var filename = "/home/canparlak/mysite/blog/admin.py";
        var hash = "25da5825a42a2ee03ab1568cce985e54";
        ...
        Anywhere2.initializeFileSharingOptions(
          ...
          {
            url: "/api/v0/user/canparlak/files/sharing/",
            csrfToken: "SqdZY35mp5BWy9zZmEnV7UU6OERVyTC5",
            path: "/home/canparlak/mysite/blog/admin.py"
          }
        );
  ...
  <div id="id_editor_toolbar">
    ...
    <div class="pull-left">
      <span id="id_breadcrumbs_div"><a class="breadcrumbs_link breadcrumb_entry" href="/user/canparlak/files/">/</a><a class="breadcrumbs_link breadcrumb_entry" href="/user/canparlak/files/home">home</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/canparlak/files/home/canparlak">canparlak</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/canparlak/files/home/canparlak/mysite">mysite</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/canparlak/files/home/canparlak/mysite/blog">blog</a><span class="breadcrumb_entry">/</span><wbr><span class="breadcrumb_entry breadcrumb_terminal">admin.py</span></span>
      ...
      <div id="id_editor_buttons_right" class="form-inline">
        ...
        <button id="id_display_sharing_options" class="btn btn-default" data-toggle="modal" data-target="#id_file_sharing_modal" title="Get a URL to share this file">
          ...
          <button class="btn btn-info run_button" title="Save &amp; Run (Ctrl + R)">
            ...
            <form class="reload_web_app" style="display: flex" method="POST" action="/user/canparlak/webapps/canparlak.pythonanywhere.com/reload">
              <button class="btn btn-default" type="submit" title="Reload canparlak.pythonanywhere.com">
    ...
    <li class=""><a id="id_dashboard_link" href="/user/canparlak/">Dashboard</a></li>
  
  <li class=""><a id="id_consoles_link" href="/user/canparlak/consoles/">Consoles</a></li>
  <li class=""><a id="id_files_link" href="/user/canparlak/files/home/canparlak">Files</a></li>
  <li class=""><a id="id_web_app_link" href="/user/canparlak/webapps/">Web</a></li>
  <li class=""><a id="id_tasks_link" href="/user/canparlak/tasks_tab/">Tasks</a></li>
  <li class=""><a id="id_databases_link" href="/user/canparlak/databases/">Databases</a></li>
...
<li class=""><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <li class=""><a href="/user/canparlak/account/" class="account_link">Account</a></li>
  <li class="">
    <form action="/logout/" method="POST">
      <input type='hidden' name='csrfmiddlewaretoken' value='SqdZY35mp5BWy9zZmEnV7UU6OERVyTC5' />
  ...
  <div>
    <div id="id_ide_split_panes">
        ...
        <div id="id_editor">from django.contrib import admin
from blog.models import Post

admin.site.register(Post)</div>
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 well">
            ...
            2 consoles.  You can
            have more if you
            <a href="/user/canparlak/account/">upgrade your account</a>!

            <p>
            Alternatively, if you don't feel like paying us more money, you
            can <a href="/user/canparlak/consoles/">kill some consoles on your Consoles page</a>.
        </div>
    </div>
</div>
